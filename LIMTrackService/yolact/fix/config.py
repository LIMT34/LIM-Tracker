...
custom_dataset = dataset_base.copy({
    ...
    # Training images and annotations
    'train_images': './data/cyto/',
    'train_info':   './data/cyto/annotations.json',

    # Validation images and annotations.
    'valid_images': './data/cyto/',
    'valid_info':   './data/cyto/annotations.json',
...
coco_base_config = Config({
    ...
    'augment_photometric_distort': False,#True,
    # Have a chance to scale down the image and pad (to emulate smaller detections)
    'augment_expand': False,#True,
    # Potentialy sample a random crop from the image and put it in a random place
    'augment_random_sample_crop': False,#True,
    # Mirror the image with a probability of 1/2 1/2
    'augment_random_mirror': True,
    # Flip the image vertically with a probability of 1/2
    'augment_random_flip': True,#False,
    # With uniform probability, rotate the image [0,90,180,270] degrees
    'augment_random_rot90': True,#False,
    #追加
    'augment_random_multiply': True,#False,
    #追加
    'augment_random_gaussianblur': False,#False,
...
yolact_base_config = coco_base_config.copy({
    ...
    # Dataset stuff
    'dataset': custom_dataset,#'dataset': coco2017_dataset,
    'num_classes': len(custom_dataset.class_names) + 1,#'num_classes': len(coco2017_dataset.class_names) + 1,
